...
const murderer = suspects.filter(function (clues) {
  return clues.bloodType === "A" && clues.height<=180 && clues.height>=155 && clues.shoeSize === 12
})
console.log(murderer)



///const shortlist = suspects.filter(function (suspect) {
///  return aOnl.includes("a")
///})
///console.log(studentsA)



///const murderer = suspects.filter(function (suspect) {
///  return (suspect.bloodType === A && height<180 && height>155 && shoeSize === 12) 
///})
///
///console.log(murderer)
